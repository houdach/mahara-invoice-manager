  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', gap: '24px', padding: '24px 40px' }}>
        {/* Left — N°, Date, Lieu only. No validity. No modified date. */}
        <div style={{ flex: 1 }}>
          {[
      ...
      <div style={{ padding: '0 40px' }}>
        ...
        {/* NO payments detail table — client doesn't need to see the breakdown */}
      </div>

      {/* FOOTER */}
      <div style={{ position: 'absolute', bottom: '0', left: '0', right: '0' }}>
        <div style={{ borderTop: `1px solid ${GRAY_LINE}`, padding: '14px 40px 8px' }}>
          <div style={{ fontWeight: 'bold', color: BURGUNDY, fontSize: '11px', textAlign: 'center' }}>COOPÉRATIVE AL MAHARA AL HIRAFIA</div>
        </div>
